...
<section class="section" id="outside">
  ...
  <div class="aside2">
    <div class="prose">
      <p>My favourite games are StarCraft II, where I play Zerg and Kerrigan is my favourite character, and the original Overwatch, where I mained D.Va. Overwatch's sound design is what got me into game development. Beyond those, RTS, shooters, puzzle games, roguelikes and idle games; I keep an eye on new releases on Steam and itch.io, and recent favourites include Balatro, Stacklands, A Dance of Fire and Ice, Chillquarium, the Rusty Lake series, There Is No Game, Melvor Idle, BattleBlock Theater and Risk of Rain.</p>
